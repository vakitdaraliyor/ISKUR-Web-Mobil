                ...
                <td>
                    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" DataKeyNames="URUN_REFNO" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" PageSize="5">
                        ...
                        <Columns>
                            ...
                            <asp:ImageField DataImageUrlField="RESIM1" DataImageUrlFormatString="/admin/Images/Urun/{0}" HeaderText="Resim1" ControlStyle-Width="50" ControlStyle-Height = "50"></asp:ImageField>
                            <asp:ImageField DataImageUrlField="RESIM2" DataImageUrlFormatString="/admin/Images/Urun/{0}" HeaderText="Resim2" ControlStyle-Width="50" ControlStyle-Height = "50"></asp:ImageField>
                            <asp:ImageField DataImageUrlField="RESIM3" DataImageUrlFormatString="/admin/Images/Urun/{0}" HeaderText="Resim3" ControlStyle-Width="50" ControlStyle-Height = "50"></asp:ImageField>
                            <asp:ImageField DataImageUrlField="RESIM4" DataImageUrlFormatString="/admin/Images/Urun/{0}" HeaderText="Resim4" ControlStyle-Width="50" ControlStyle-Height = "50"></asp:ImageField>
                        </Columns>
